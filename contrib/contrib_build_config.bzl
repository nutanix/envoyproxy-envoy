...
CONTRIB_EXTENSIONS = {
    ...
    "envoy.bootstrap.reverse_connection.reverse_connection_socket_interface": "//contrib/reverse_connection/bootstrap/source:downstream_reverse_socket_interface_lib",
