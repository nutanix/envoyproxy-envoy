 ...
 * This class extends SocketInterfaceExtension and initializes the upstream reverse socket interface.
 */
...
public:
   ...
   * @param rebalanced is true if we are adding to the socket after rebalancing to pick the most appropriate thread.
   */
   ...
   * @param used is true, when the connection the fd belongs to has been used for servicing a request.
   */
