...
const std::string ReverseConnectionHandler::ping_message = "RPING";
std::vector<ReverseConnectionHandler*> ReverseConnectionHandler::handlers_{};
absl::Mutex ReverseConnectionHandler::handler_lock{};

ReverseConnectionHandler::ReverseConnectionHandler(Event::Dispatcher* dispatcher)
    : dispatcher_(dispatcher) {
  random_generator_ = std::make_unique<Random::RandomGeneratorImpl>();
  ping_timer_ = dispatcher_->createTimer([this]() { pingConnections(); });

  absl::MutexLock lock(&ReverseConnectionHandler::handler_lock);
  ReverseConnectionHandler::handlers_.push_back(this);
}

void ReverseConnectionHandler::tryEnablePingTimer(const std::chrono::seconds& ping_interval) {
...
ReverseConnectionHandler::pickMinHandler(const std::string& node_id,
  ...
  ReverseConnectionHandler* min_handler = this;
  ...
  // the node 'node_id'.
  for (ReverseConnectionHandler* handler : handlers_) {
...
ReverseConnectionHandler::pickTargetHandler(const std::string& node_id,
  ...
  ReverseConnectionHandler* target_handler = nullptr;
...
void ReverseConnectionHandler::cleanStaleNodeEntry(const std::string& node_id) {
...
RCHandlerStats* ReverseConnectionHandler::getStatsByNode(const std::string& node_id) {
...
RCHandlerStats* ReverseConnectionHandler::getStatsByCluster(const std::string& cluster_id) {
...
bool ReverseConnectionHandler::deleteStatsByNode(const std::string& node_id) {
...
bool ReverseConnectionHandler::deleteStatsByCluster(const std::string& cluster_id) {
...
void ReverseConnectionHandler::rebalanceGetConnectionSocket(
...
ReverseConnectionHandler::getConnectionSocket(const std::string& key, bool rebalanced) {
...
uint64_t ReverseConnectionHandler::getNumberOfSocketsByCluster(const std::string& cluster_id) {
...
absl::flat_hash_map<std::string, size_t> ReverseConnectionHandler::getSocketCountMap() {
...
void ReverseConnectionHandler::markSocketDead(const int fd, const bool used) {
...
void ReverseConnectionHandler::onPingResponse(Network::IoHandle& io_handle) {
...
void ReverseConnectionHandler::pingConnections(const std::string& node_id) {
...
void ReverseConnectionHandler::pingConnections() {
...
void ReverseConnectionHandler::initializeStats(Stats::Scope& scope) {
...
absl::flat_hash_map<std::string, size_t> ReverseConnectionHandler::getConnectionStats() {
