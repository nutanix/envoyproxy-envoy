...
private:
  ...
  Network::ReverseConnectionHandler& reverseConnectionHandler() {
    return decoder_callbacks_->dispatcher().connectionHandler()->reverseConnRegistry().getRCHandler();
  }

  Network::ReverseConnectionManager& reverseConnectionManager() {
    return decoder_callbacks_->dispatcher().connectionHandler()->reverseConnRegistry().getRCManager();
  }
